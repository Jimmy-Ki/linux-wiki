              ...
              <div className={styles.actionButtons}>
                ...
                <div className={styles.downloadButtons}>
                  ...
                  <button
                    ...
                    className={styles.downloadButton}
                  >
                    <IconPhoto size={16} /> JPG
                  </button>
                  <button
                    onClick={() => downloadQRCode('svg')}
                    className={styles.downloadButton}
                  >
                    <IconFileText size={16} /> SVG
                  </button>
                </div>
              </div>
            )}
