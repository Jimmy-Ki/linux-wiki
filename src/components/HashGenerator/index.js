    ...
    <div className={styles.container}>
      <div className="container">
            ...
            <div className={styles.buttonGroup}>
              ...
              <label className={styles.fileButton}>
                <input
                  ...
                  style={{ display: 'none' }}
                />
                <IconFileText size={16} /> Load File
              </label>
            ...
            {hashAlgorithms.map(algo => (
              ...
              >
                ...
                <div className={styles.checkbox}>
                  {activeHashes[algo.key] && <IconCheck size={16} />}
                </div>
              </label>
            ))}
          </div>
              ...
              <div className={styles.stats}>
                ...
                {compareHashes().collisions > 0 && (
                  <span className={styles.collisionBadge}>
                    <IconX size={16} /> {compareHashes().collisions} collision{compareHashes().collisions > 1 ? 's' : ''}
                  </span>
                )}
              </div>
            </div>
        ...
        <div className={styles.securityInfo}>
          <h2><IconShieldCheck size={16} /> Security Information</h2>
          <div className={styles.securityGrid}>
            <div className={`${styles.securityCard} ${styles.deprecated}`}>
              <h4><IconX size={16} /> Deprecated for Security</h4>
            ...
            <div className={`${styles.securityCard} ${styles.recommended}`}>
              <h4><IconCheck size={16} /> Recommended</h4>
            ...
            <div className={`${styles.securityCard} ${styles.modern}`}>
              <h4><IconRefresh size={16} /> Modern Alternatives</h4>
            ...
            <div className={`${styles.securityCard} ${styles.specialized}`}>
              <h4><IconSearch size={16} /> Specialized Use</h4>
