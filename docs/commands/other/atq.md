...
The `atq` command list jobs queued by at.
...
The `atq` command is part of the `other` category in Linux systems. It provides essential functionality for list jobs queued by at.

Refer to the manual page (`man atq`) for detailed information about all available options and usage patterns.
