...
The `chsh` command change login shell.
...
The `chsh` command is part of the `user-management` category in Linux systems. It provides essential functionality for change login shell.

Refer to the manual page (`man chsh`) for detailed information about all available options and usage patterns.
